...
const SessionPanel = ({
  ...
  return (
    <section className="sessionPanel">
      <div className="sessionPanel__scroll">
            ...
            <div key={group.skaterId} className="sessionPanel__attemptGroup">
              ...
              {group.attempts.map((entry) => (
                <div key={entry.id} className="sessionPanel__attemptItem">
                  ...
                  <div className="sessionPanel__attemptBody">
                    <div className="sessionPanel__attemptTitle">{entry.trickName || entry.coreName || "No Attempt"}</div>
                    <div className="sessionPanel__attemptMeta">
                      {entry.type} | {entry.pieceName}
                      {entry.pieceCoordinate ? ` (${entry.pieceCoordinate})` : ""}
                    </div>
                    <div className="sessionPanel__attemptScores">
                    ...
                    <div className="sessionPanel__attemptFlags">
